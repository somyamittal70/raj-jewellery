...
export default function CategoryProductDetail() {
  const { metal, gender, catSlug, productSlug } = useParams()

  // Build category slug from params
  const categorySlug = [metal, gender, catSlug].filter(Boolean).join('/')
  const product = getProductByPath(categorySlug, productSlug)
    ...
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4 flex-wrap">
                ...
                {genderLabel && (
                  <span className="text-[0.6rem] tracking-[0.2em] uppercase px-2.5 py-1 border border-espresso/20 text-espresso/60">
                    {genderLabel}
                  </span>
                )}
              </div>
      ...
      <section className="py-14 px-6 bg-espresso">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className='btn-gold flex items-center gap-2.5 flex-shrink-0'>
