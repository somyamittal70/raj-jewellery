      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 bg-ivory">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-14">
            <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="section-label">Shop by Metal</motion.span>
...
const BANNER_IMAGES = {
  gold: 'https://i.pinimg.com/1200x/c3/ab/cb/c3abcbd1eb2eebdc0dbefa6b53f5d1b9.jpg',
      ...
      <section className="py-20 px-6 bg-cream min-h-[60vh]">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            ...
            <span className="text-espresso/35 text-xs tracking-widest hidden sm:block">
