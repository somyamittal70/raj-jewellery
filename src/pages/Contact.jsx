...
export default function Contact() {
  return (
    ...
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <h2 className="font-display text-espresso text-4xl mt-4 mb-4 leading-tight">
                  We'd Love to
                  <br /><span className="text-gold">Hear From You</span>
                </h2>
                <div className="gold-divider-left mb-8" />
                <p className="text-espresso/60 text-sm leading-relaxed mb-12">
            ...
            <div className="lg:col-span-3">
              <motion.div
                ...
                className="bg-ivory p-10 sm:p-14"
              >
                <span className="section-label">Send a Message</span>
                <h3 className="font-display text-espresso text-3xl mt-4 mb-10">
      ...
      {/* Map placeholder */}
      <section className="h-80 bg-espresso/10 relative overflow-hidden">
        <img
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <div className="font-display text-espresso text-xl">12, Jewellers Row, New Delhi</div>
          </div>
        </div>
      </section>
    </motion.div>
